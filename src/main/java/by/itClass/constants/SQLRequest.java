...
public final class SQLRequest {
    ...
    public static final String WHERE_BY_ID = "where events.id=?";
    ...
    public static final String ADD_PROGRAM = "insert into programs(idEvent, title, time) values(?,?,?)";
    public static final String GET_PROGRAMS = "select * from programs where idEvent=?";
}
